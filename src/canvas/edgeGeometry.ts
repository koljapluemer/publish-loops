...
// Ported from the official @xyflow/react "Floating Edges" example. Computes
// where the line between two node centers crosses intersectionNode's
// rectangular border, using a scaled superellipse formula on half-width/
// half-height. Only valid for rectangular nodes.
...
// Classifies the intersection point as Top/Right/Bottom/Left relative to the
// node's bounding box.
